...
// Screen 1 — Home. A warm greeting, then four large word-labelled actions. "Chat with MedThread" is the
...
export default function Home() {
  ...
  return (
    <Screen scroll>
      ...
      <ActionButton label="Chat with MedThread" primary onPress={() => router.push("/ask")} />
