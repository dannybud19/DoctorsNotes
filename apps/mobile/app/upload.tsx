  ...
  return (
    <SafeAreaView style={styles.safe} edges={["top", "bottom"]}>
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        {/* The pill straddles the panel boundary, as in the reference. */}
        <View style={styles.lower}>
          ...
          <Pressable
            ...
            hitSlop={HIT_SLOP}
            accessibilityRole="button"
            accessibilityLabel="Choose a document from your photos. PNG or JPEG."
          ...
          >
            ...
            <View style={styles.galleryCopy}>
              ...
              {/*
                The caption states only what can actually be opened TODAY. Adding PDF here needs two
                changes first: expo-document-picker on this screen (expo-image-picker cannot select a
                PDF at all), and packages/ai accepting application/pdf — it currently throws
                "unsupported image type" for anything outside jpeg/png/gif/webp. Flip this the moment
                both land, not before: promising a PDF that dead-ends is worse than not offering it.
              */}
              <Text style={styles.galleryHint}>PNG or JPEG</Text>
            </View>
          </Pressable>
